    ...
    <AnimatePresence>
      ...
      >
        <div className="mx-auto max-w-4xl md:bg-sky-800/60 rounded-sm md:shadow-lg p-10 text-slate-300">
          ...
          <p className="">
            A <span className="text-slate-100">React.js</span> app to search
            GitHub profiles and see profile details. This app uses the{" "}
            ...
            <span className="text-slate-100"> "React Front To Back"</span>{" "}
            course from
            <a
